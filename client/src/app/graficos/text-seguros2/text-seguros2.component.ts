...
@Component({
  selector: 'app-text-seguros2',
  templateUrl: './text-seguros2.component.html',
  styleUrls: ['./text-seguros2.component.scss']
})
export class TextSeguros2Component {
  ...
  ngOnInit(): void {
    ...
    this.matriculaServicio.estadisticas$.subscribe(valor => {
      ...
      this.electromecanicax = this.matriculaServicio.electromecanica;
      this.instalacionex = this.matriculaServicio.instalaciones;
      this.mecanizadox = this.matriculaServicio.mecanizado;
      this.seguridadx = this.matriculaServicio.seguridad;
      this.soldadurax = this.matriculaServicio.soldadura;
